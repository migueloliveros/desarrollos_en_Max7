...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 374.0, 73.0, 346.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "grabbr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 6.0, 972.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2.0, 753.0, 606.0, 196.0 ],
					"presentation_rect" : [ 0.0, 0.0, 606.0, 196.0 ],
...
,
					"saved_object_attributes" : 					{
						"annotation_name" : "",
						"parameter_enable" : 1,
						"patchername" : "Example M4L Instrument.amxd",
						"patchername_fallback" : "C74:/packages/BEAP/Examples/Synthesis Examples/Example M4L Instrument.amxd"
					}
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"name" : "Example M4L Instrument.amxd",
							"origname" : "C74:/packages/BEAP/Examples/Synthesis Examples/Example M4L Instrument.amxd",
							"valuedictionary" : 							{
								"parameter_values" : 								{
									"BendRange" : 2.0,
									"Bypass[4]" : 0.0,
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "Example M4L Instrument.amxd",
									"origin" : "Example M4L Instrument.amxd",
									"type" : "amxd",
									"subtype" : "Undefined",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "Example M4L Instrument.amxd",
										"filename" : "Example M4L Instrument.amxd.maxsnap",
										"filepath" : "~/Documents/Max 7/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "6fad581c6704caf79b116603d8226de0"
									}
...
,
					"style" : "",
					"text" : "amxd~ \"Example M4L Instrument.amxd\"",
					"varname" : "amxd~",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 6.0, 584.0, 226.0, 112.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 9.0, 397.5, 178.0, 113.0 ],
					"prototypename" : "pixl",
					"varname" : "analyzr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ -30.0, 243.0, 178.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "2switchr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 6.0, 73.0, 348.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "playr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 907.200073, 5.599988, 150.0, 20.0 ],
					"style" : ""
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 50.0, 333.5, 82.0, 22.0 ],
									"style" : "",
									"text" : "midiformat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 252.5, 39.0, 22.0 ],
									"style" : "",
									"text" : "join 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 277.0, 163.5, 119.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 164.5, 105.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 163.5, 105.0, 22.0 ],
									"style" : "",
									"text" : "scale 0. 1. 42 100"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 195.5, 246.0, 22.0 ],
									"style" : "",
									"text" : "makenote"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 378.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 59.5, 277.75, 59.5, 277.75 ],
									"source" : [ "obj-89", 0 ]
								}
...
,
					"patching_rect" : [ 6.0, 530.0, 184.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"style" : "",
					"text" : "p \"Convert colors to MIDI notes\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 972.0, 148.0, 111.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 397.5, 178.0, 113.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 374.0, 73.0, 344.0, 158.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 753.0, 598.0, 173.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 584.0, 169.0, 117.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 250.0, 178.0, 130.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-8::obj-10::obj-2" : [ "pastebang", "pastebang", 0 ],
			"obj-6::obj-112::obj-92" : [ "FreqMode[13]", "FreqMode", 0 ],
			"obj-8::obj-12" : [ "bypass", "bypass", 0 ],
			"obj-8::obj-48" : [ "InputLED", "InputLED", 0 ],
			...
			"obj-8::obj-92" : [ "kslider", "kslider", 0 ],
			"obj-10::obj-55" : [ "DSP", "DSP", 0 ],
			"obj-8::obj-100" : [ "score", "score", 0 ],
			"obj-8::obj-29" : [ "OutputLED", "OutputLED", 0 ],
...
, 			{
				"name" : "Example M4L Instrument.amxd.maxsnap",
...
, 			{
				"name" : "Example M4L Instrument.amxd",
				"bootpath" : "C74:/packages/BEAP/Examples/Synthesis Examples",
				"type" : "amxd",
				"implicit" : 1
			}
, 			{
